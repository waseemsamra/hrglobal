...
export async function generateMetadata() {
  ...
  return { title: `${org} — Employer Login` };
}
  ...
  return (
    <main className="min-h-screen w-full flex bg-background text-on-surface">
        ...
        <div className="relative z-20 flex flex-col justify-between p-margin-desktop w-full text-white">
          ...
          <div className="max-w-md">
            ...
            <p className="font-body-lg text-body-lg text-surface-variant opacity-90">
              Access your comprehensive suite of human resource management tools. Designed for
              precision, built for growth.
            </p>
            <div className="mt-12 flex gap-8">
              ...
              <div>
                <div className="text-secondary-fixed font-headline-lg text-headline-lg">99.9%</div>
                <div className="text-label-sm uppercase tracking-widest opacity-70">Uptime</div>
              </div>
              <div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-margin-mobile md:p-margin-desktop bg-surface">
        <EmployerLoginForm orgName={orgName} />
      </div>
    </main>
  );
}
